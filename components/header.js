    ...
    return (
        <div className="grid grid-cols-3 items-center gap-4 px-4 py-2">
            ...
            <div className="col-span-1 flex justify-between space-x-8">
                <a href="#about" className="text-[#37424f] hover:text-[#FF6B6B] no-underline text-xl">Über mich</a>
                <a href="#projects" className="text-[#37424f] hover:text-[#FF6B6B] no-underline text-xl">Projekte</a>
                <a href="#contact" className="text-[#37424f] hover:text-[#FF6B6B] no-underline text-xl">Kontakt</a>
            </div>
